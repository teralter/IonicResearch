...
namespace IonicResearch.Data.Migrations
{
    ...
    [Migration("20190312181415_OutletTypeId")]
    partial class OutletTypeId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IonicResearch.Data.Models.FiasAddressObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("IonicResearch.Data.Models.FiasHouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("IonicResearch.Data.Models.FiasAddressObject", b =>
                {
                    b.HasOne("IonicResearch.Data.Models.FiasAddressObject", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("IonicResearch.Data.Models.FiasHouse", b =>
                {
                    b.HasOne("IonicResearch.Data.Models.FiasAddressObject", "AddressObject")
                        .WithMany()
